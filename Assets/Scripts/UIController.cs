...
public class UIController : MonoBehaviour {
    ...
    class InventoryItem
    {
        ...
        public void UpdateInventoryUI(GameObject inventoryUI)
        {
            ...
            itemTituloText = itemBGPanelTransform.Find("ItemTitleText").GetComponent<Text>();
            itemDescripcionText = itemBGPanelTransform.Find("ItemDescriptionText").GetComponent<Text>();
            ...
            itemTituloText.text = itemTitle;
            itemDescripcionText.text = itemDescription;
        }
    }
}
